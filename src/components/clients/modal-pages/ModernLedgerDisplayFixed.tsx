                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setShowActionsFor(showActionsFor === entry._id ? null : entry._id);
                        }}
                      ...
                      <div className="mt-2 space-y-1">
                        {onCommentAdd && (
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              onCommentAdd(entry._id, { content: 'Nouveau commentaire', author: 'User' });
                            ...
                            <div className="py-1">
                              {onCommentAdd && (
                                <button
                                  ...
                                  className="w-full flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700"
                                >
                                  <MessageCircle className="w-4 h-4" />
                                  <span>Ajouter commentaire</span>
                                </button>
                              ...
                              {onExport && (
                                <button
                                  ...
                                  className="w-full flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-700"
                                >
                                  <Download className="w-4 h-4" />
                                  <span>Exporter</span>
                                </button>
